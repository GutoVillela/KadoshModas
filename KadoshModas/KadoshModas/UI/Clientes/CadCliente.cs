    ...
    public partial class CadCliente : Form
    {
        ...
        private void PreencherCampos(DmoCliente pDmoCliente)
        {
            ...
            if(pDmoCliente.Telefones != null && pDmoCliente.Telefones.Any())
            {
                if(pDmoCliente.Telefones.Count > 1)
                {
                    ...
                    {
                        lstTelefones.Items.Add("(" + telefone.DDD + ")" + telefone.Numero + " - " + telefone.TipoDeTelefone.DescricaoEnum() + " - Falar com: " + (string.IsNullOrEmpty(telefone.FalarCom) ? " O próprio cliente" : telefone.FalarCom));
                    }
                }
                else
                {
        ...
        private bool AdicionarTelefone()
        {
            ...
            if (!string.IsNullOrEmpty(numTelefone) && numTelefone.Length >= 10)
            {
                ...
                string numLista = "(" + telefone.DDD + ")" + telefone.Numero + " - " + telefone.TipoDeTelefone.DescricaoEnum() + " - Falar com: " + (string.IsNullOrEmpty(telefone.FalarCom) ? " O próprio cliente" : telefone.FalarCom);
